...
BEGIN
    ...
    BEGIN
        CALL create_reservation(
            v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-01 14:00', TIMESTAMP '2026-05-02 12:00',
            FALSE, '11111111-1111-1111-1111-111111111001'
        );
    ...
    BEGIN
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-03 14:00', TIMESTAMP '2026-05-04 12:00', FALSE,
    ...
    BEGIN
        ...
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-02 14:00', TIMESTAMP '2026-05-03 12:00', FALSE,
    ...
    CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
        TIMESTAMP '2026-05-01 14:00', TIMESTAMP '2026-05-02 12:00', FALSE,
    ...
    BEGIN
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-04 14:00', TIMESTAMP '2026-05-05 12:00', FALSE,
    ...
    BEGIN
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-05 14:00', TIMESTAMP '2026-05-06 12:00', FALSE,
    ...
    BEGIN
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-02 07:00', TIMESTAMP '2026-05-03 12:00', FALSE,
            '11111111-1111-1111-1111-111111111313');
    ...
    BEGIN
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-04 14:00', TIMESTAMP '2026-05-05 12:00', FALSE,
            '11111111-1111-1111-1111-111111112020');
    ...
    BEGIN
        ...
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-05-04 14:00', TIMESTAMP '2026-05-05 12:00', FALSE,
            '11111111-1111-1111-1111-111111112021');
    ...
    BEGIN
        ...
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-06-01 14:00', TIMESTAMP '2026-06-02 12:00', FALSE,
            '11111111-1111-1111-1111-111111113030');
    ...
    BEGIN
        ...
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            TIMESTAMP '2026-06-03 14:00', TIMESTAMP '2026-06-04 12:00', FALSE,
            '11111111-1111-1111-1111-111111113033');
    ...
    BEGIN
        ...
        CALL create_reservation(v_hotel_id, v_customer_id, v_room_type_id, 1,
            (NOW() - INTERVAL '1 hour')::TIMESTAMP, (NOW() + INTERVAL '1 day')::TIMESTAMP, FALSE,
            '11111111-1111-1111-1111-111111113035'::UUID);
